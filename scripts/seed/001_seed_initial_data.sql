...
USING (
    ...
    FROM (VALUES
        ...
        (@TenantAdminRoleId, N'ai.settings.view'), (@TenantAdminRoleId, N'ai.assistant.use'), (@TenantAdminRoleId, N'job.requests.view'), (@TenantAdminRoleId, N'job.requests.create'),
        ...
        (@SystemAdminRoleId, N'ai.settings.view'), (@SystemAdminRoleId, N'ai.assistant.use'), (@SystemAdminRoleId, N'job.requests.view'), (@SystemAdminRoleId, N'job.requests.create'),
        ...
        (@PmoRoleId, N'job.requests.view'), (@PmoRoleId, N'job.requests.create'), (@PmoRoleId, N'workflow.assignments.claim'), (@PmoRoleId, N'bench.matches.view'), (@PmoRoleId, N'ai.assistant.use'),
        (@RecruiterRoleId, N'job.requests.view'), (@RecruiterRoleId, N'workflow.assignments.claim'), (@RecruiterRoleId, N'candidates.manage'), (@RecruiterRoleId, N'interviews.manage'), (@RecruiterRoleId, N'ai.assistant.use'),
        ...
        (@HiringManagerRoleId, N'job.requests.view'), (@HiringManagerRoleId, N'workflow.assignments.claim'), (@HiringManagerRoleId, N'hiring.decisions.manage'), (@HiringManagerRoleId, N'ai.assistant.use')
